...
@pytest.fixture
def get_token_exception_handler() -> TokenExceptionHandler:
...
def test_exception_handler(get_token_exception_handler: TokenExceptionHandler, exception, expected_status, expected_message):
    ...
    with pytest.raises(HTTPException) as expected_exception:
        get_token_exception_handler.handle_token_exceptions(raise_exception)()
